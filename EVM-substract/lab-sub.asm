...
mov ah,02     ; код функции DOS для вывода одного символа на экран через прерывание
mov dl,2dh     ;  выводит знак минуса, если результат вычитания был отрицательным
